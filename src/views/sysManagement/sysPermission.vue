<template>
	<section class="app-container">
      ...
      <el-table-column prop="resourceType" label="资源类型" width="170">
			</el-table-column>
			<el-table-column prop="URL" label="URL" width="170">
			</el-table-column>
      <el-table-column prop="permission" label="权限字符串" width="170">
      </el-table-column>
      <el-table-column prop="parentId" label="父权限" width="170">
      </el-table-column>
      <el-table-column prop="parentIds" label="父权限组" width="170">
      </el-table-column>
      <el-table-column prop="remark" label="备注" width="170">
      </el-table-column>
      <el-table-column prop="available" label="状态" width="170" :formatter="formatState">
      </el-table-column>
...
export default {
  ...
  methods: {
    ...
    formatState: function(row, column) {
      return row.sex === 1 ? '可用' : row.sex === 0 ? '禁用' : '未知'
    },
