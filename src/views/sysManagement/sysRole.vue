<template>
	<section class="app-container">
		...
		<el-table :data="users" highlight-current-row @selection-change="selsChange" style="width: 100%;">
			...
			<el-table-column prop="role" label="角色" width="340">
			</el-table-column>
			<el-table-column prop="description" label="角色名称" width="340">
			</el-table-column>
			<el-table-column prop="available" label="可用状态" width="340" :formatter="formatAvailable">
			</el-table-column>
			<el-table-column prop="remark" label="备注" width="340">
			</el-table-column>
...
export default {
  ...
  methods: {
    ...
    formatAvailable: function(row, column) {
      return row.sex === 1 ? '禁用' : row.sex === 0 ? '禁用' : '未知'
    },
