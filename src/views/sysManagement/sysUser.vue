<template>
	<section class="app-container">
      ...
      <el-table-column prop="username" label="用户名" width="220">
			...
			<el-table-column prop="sex" label="性别" width="220" :formatter="formatSex">
			</el-table-column>
      <el-table-column prop="dept" label="部门" width="220">
      </el-table-column>
      <el-table-column prop="tel" label="电话" width="220">
      </el-table-column>
      <el-table-column prop="phone" label="手机" width="220">
      </el-table-column>
      <el-table-column prop="state" label="状态" width="220" :formatter="formatState">
      </el-table-column>
